...
const socials = [
  ...
  {Icon : FaLinkedin, label : "LinkedIn", href : "https://www.linkedin.com/in/harshal-patil-java/"},
  {Icon : FaGithub, label : "GitHub", href : "https://github.com/Harshal005"},
]

const Home = () => {

  const roles = useMemo(() => ["Java Full Stack Developer", "Software Developer","Web Developer","Front-End Developer", "React.js Developer"], []);
    ...
    >
      ...
      <div className="absolute inset-0">
        <div
          ...
          max-w-[500px] max-h-[500px] rounded-full bg-gradient-to-r from-[#302b63] via-[#00bf8f] to-[#1cd8d2]
        ...
        <div
          ...
          max-w-[500px] max-h-[500px] rounded-full bg-gradient-to-r from-[#302b63] via-[#00bf8f] to-[#1cd8d2]
          opacity-30 sm:opacity-20 md:opacity-10
          blur-[100px] sm:blur-[130px] md:blur-[150px] animate-pulse delay-500"
            ></div>
              ...
              <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
                <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
                  ...
                  animate={{opacity:1, y:0}} transition={{delay:0.4, duration:0.8}}>
                    I turn complex idea into seamless, high-impact web experiences - building modern, scalable, and lightning-fast applications that make a difference.
                  </motion.p>
                  ...
                  transition={{delay:0.8, duration:0.8}}>
                    ...
                    <a href="/Resume.pdf" className="px-6 py-3 rounded-full font-medium text-black bg-white hover:bg-gray-200 shadow-lg hover:scale-105 transition-all">My Resume</a>
                  </motion.div>
